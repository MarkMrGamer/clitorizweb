...
'picture' => "http://clitoriz.cf/images/pfps/" .$row2['pfp'].".gif",
...
$frarr[$ccount] = array('name' => $friend_details2["username"], 'pfp' => "http://clitoriz.cf/images/pfps/" .$friend_details2["pfp"].".gif");
$ccount = $ccount + 1;
}
}

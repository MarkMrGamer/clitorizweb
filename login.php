...
<tbody>
<tr>
<td class="hmcontainer2"><font size="+1"><b>clitorizweb login</b></font>
<br>
<br>
<form action="login.php" method="POST">
<label>username:</label> <input class="loginText" type="text" name="username"><br><br>
<label>password:</label> <input class="loginText" type="password" name="password"><br><br><input class="loginSubmit" type="submit" name="login" value="Login"> or <a href="signup.php">sign up</a></form>

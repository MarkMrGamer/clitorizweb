...
<tbody>
<tr>
<td class="hmcontainer2"><font size="+1"><b>Announce a message</b></font>
<br>
<br>
...
<label>bgcolor:</label> <input class="UpdateText" type="text" name="bgcolor_announce"><br><br>
<label>textcolor:</label> <input class="UpdateText" type="text" name="textcolor_announce"><br><br>
<br><br><input class="updateSubmit" type="submit" name="announce" value="Announce message"> <input class="updateSubmit" type="submit" name="clear" value="clear"></form>
</td>
</tr>
</tbody>
</table>

            ...
            <tbody>
               <tr>
                  <td class="hmcontainer2">
                     <font size="+1"><b>clitorizweb registration</b></font>
                     <br>
                     <br>
                     ...
                     <form action="signup.php" method="POST">
                        ...
                        <label>password:</label> <input class="loginText" type="password" name="password_one"><br><br><label>confirm password:</label> <input class="loginText" type="password" name="password_two"><br><br>
                        <div class="g-recaptcha" data-sitekey="6Lcamg4cAAAAAJXaGf4XDlxCluMP9jZlzotKUYu8"></div>
                        <br><br><input class="loginSubmit" type="submit" name="signup" value="Sign Up"> or <a href="login.php">login</a><br><br>

...
-- Dumping structure for table test_clitorizweb.clitorizweb_badges
...
-- Dumping structure for table test_clitorizweb.clitorizweb_banner
...
-- Dumping structure for table test_clitorizweb.clitorizweb_bans
...
-- Dumping structure for table test_clitorizweb.clitorizweb_comments
...
-- Dumping structure for table test_clitorizweb.clitorizweb_friends
...
-- Dumping structure for table test_clitorizweb.clitorizweb_groups
...
-- Dumping structure for table test_clitorizweb.clitorizweb_group_users
...
-- Dumping structure for table test_clitorizweb.clitorizweb_logs
...
-- Dumping structure for table test_clitorizweb.clitorizweb_replies
...
-- Dumping structure for table test_clitorizweb.clitorizweb_reports
...
-- Dumping structure for table test_clitorizweb.clitorizweb_threads
...
-- Dumping structure for table test_clitorizweb.clitorizweb_users

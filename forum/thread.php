...
<td class="hmcontainer2" width="300" height="30" valign="top"><table><tbody><tr>
<td><font class="Profile" size="1"><b>Posted</b>: <?php $date = strtotime($replies_details["post_date"]); echo date('d/m/Y h:i A', $date); ?></font><b><br></b><font class="Profile" size="1"><?php $post = $replies_details["post_text"]; require("lib/embeds.php"); ?></font><br><br><?php if (isset($username)) { if ($thread_details["thread_locked"] == "no") { ?><font size="1"><a href="new_reply.php?id=<?php echo $thread_details["thread_id"]; ?>">Post Reply</a></font><?php } } ?> <?php if (isset($username)) { if ($username == $author_details2["username"] OR $user["badge"] == "administrator") { ?><font size="1"><a href="thread.php?delete_reply=<?php echo $replies_details["post_id"]; ?>">Delete</a></font><?php } } ?></td>
</tr>
</tbody></table></td></tr>
<?php 
}
